...
import { InsertUpdateEnfermedadComponent } from './insert-update-enfermedad/insert-update-enfermedad.component';
...
export class EnfermedadComponent {
  ...
  constructor(
    public _service: PackageEnfermedadService,
  ...
  crear() {
    ...
    this._dialog.open(InsertUpdateEnfermedadComponent);
