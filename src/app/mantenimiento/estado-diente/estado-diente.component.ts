...
import { FormEstadoDienteComponent } from './form-estado-diente/form-estado-diente.component';
...
@Component({
  selector: 'app-estado-diente',
  templateUrl: './estado-diente.component.html',
  styleUrls: ['./estado-diente.component.css']
})
export class EstadoDienteComponent {
  pageSize: number = 25;
  ...
  constructor(
    public _service: EstadoDienteService,
  ...
  crear() {
    ...
    this._dialog.open(FormEstadoDienteComponent);
